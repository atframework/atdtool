...
// WhiteListConf represents a nonCloudNative white list configuration
type WhiteListConf struct {
	XMLName xml.Name  `xml:"nonCloudNativecenter"`
	IPList  []*string `xml:"AccessWhiteList>ipList" json:"ip_list"`
}

func loadWhiterListConfig(filename string) (nonCloudNativeConf, error) {
...
// XMLExport export nonCloudNative whitelist xml configuration
